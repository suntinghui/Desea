...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    LoginViewController *loginViewController = [[LoginViewController alloc] initWithNibName:@"LoginViewController" bundle:nil];
     ...
     MessSecMenuViewController *messSecMenuViewController = [[MessSecMenuViewController alloc] initWithNibName:@"MessSecMenuViewController" bundle:nil];
    ...
    {
        [UserDefaults setObject:DEFAULTHOST forKey:kHostAddress];
        [UserDefaults synchronize];
    }
    
    //向微信注册
//    [WXApi registerApp:@"wx4cc9414dbc4a2405"];
